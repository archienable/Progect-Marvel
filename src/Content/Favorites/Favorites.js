...
const Favorites = () => {
    ...
    // const [dataFilm, setDataFilm] = useState(JSON.parse(localStorage.getItem('FavoritesMovies')) || [])
    // const [dataShow, setDataShow] = useState(JSON.parse(localStorage.getItem('FavoritesTvShows')) || [])
