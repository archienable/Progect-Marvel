            ...
            <div className={style.containerTvShows}>
                ...
                <div className={style.contentTvShows}>
                    {data.map( show => {
                        ...
                        return (
                            <Link className={style.link} to={`/tvShows/${show.id}`} key={`tvShows-list-item-${show.id}`}>
                                    ...
                                    <div className={style.infoShow}>
                                        ...
                                        <div className={style.favorite} onClick={(event) => {
                                            ...
                                            <svg className={style.svg} xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 100 100" width="20px" height="20px">
                                                ...
                                                <path fill="none" stroke="#40396e" strokeLinejoin="round" strokeMiterlimit="20" strokeWidth="3" d="M26.5,10.5h47	c2.209,0,4,1.791,4,4v75L50,69.5l-27.5,20v-75C22.5,12.291,24.291,10.5,26.5,10.5z"/>
                                            </svg>
                                        </div>
